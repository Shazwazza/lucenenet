...
To build the api docs and run it on your machine, run the Powershell script: `/websites/apidocs/docs.ps1`. 
...
* `-Clean` _(_(optional)_ A boolean switch.  If present, it will clear all caches and tool files before it builds again. This is handy if a new version of docfx is available or if there's odd things occurring with the incremental build.
